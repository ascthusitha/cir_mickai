    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-1">
             <a href="<?php echo $base_link; ?>phone_call/add" class="btn btn-block bg-gradient-success btn-flat">Add New</a>
                        ...
                        <tbody>
                            ...
                            if (count($phone_call)) {
                                ...
                                foreach ($phone_call as $g) {
                                    ...
                                    echo "<td><a href='javascript:void(0)' onclick='deletePC($g->pc_id)' ><span class='fa fa-trash-alt'></span></a></td>";
                                    echo "</tr>";
                                    $i++;
                                }
                            }
