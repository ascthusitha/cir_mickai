    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-1">
                    <a href="<?php echo $base_link; ?>phone_call/add"
                        class="btn btn-block bg-gradient-success btn-flat">Add New</a>
                        ...
                        <?php
                            if (count($phone_call)) {
                                ...
                                foreach ($phone_call as $g) {
                                    ...
                                    echo "<tr>";
                                    echo "<td>" . $i . "</td>";
                                    echo "<td>" . anchor('phone_call/view/' . $g->pc_id, $g->subject) . "</td>";
                                    ...
                                    echo "<td><a href='javascript:void(0)' onclick='deletePC($g->pc_id)' ><i class='fas fa-trash-alt' style='font-size:16px;color:red'></i></a></td>";
                                    echo "</tr>";
                                    $i++;
                                }
                            }
...
function deletePC(pc_id) {
    var val = confirm('Are you sure want to delete this  Phone Call ?');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if ($.trim(data) == 'Success') {
                    alert(" Phone Call Successfully Removed");
                    location.reload();
                } else {
                    alert(data);
                }
