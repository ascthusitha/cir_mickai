...
<aside class="main-sidebar sidebar-dark-orange elevation-4">
    ...
    <a href="<?php echo $base_link; ?>dashboard/" class="brand-link">
        <img src="<?php echo base_url(); ?>assets/dist/img/MickaiLogo.png" alt="AdminLTE Logo" class="brand-image "
            style="opacity: .8">
              ...
              <p>My Drive</p>
                ...
                <li class="nav-item <?php echo $menu_open[19];?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo $base_link; ?>administration_reports/activities"
                                class="nav-link <?php echo $menu[20];?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Activity Report</p>
                            </a>
                        </li>
                ...
                <li class="nav-item <?php echo $menu_open[2];?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo $base_link; ?>Financial_year/view"
                                class="nav-link <?php echo $menu[3];?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Financial year</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo $base_link; ?>user_group_permission"
                                class="nav-link <?php echo $menu[5];?>">
                                <i class="far fa-circle nav-icon"></i>
