    ...
    <div class="card">
      <div class="card-header">
        <div class="card-tools">
          <a href="<?php echo $base_link; ?>task_detail/add" type="button" class="btn btn-primary btn-block"><i class="fas fa-plus-circle"></i> Add New</a>
        </div>
      </div>
      <div class="card-body">
          ...
          <tbody>
            <?php
              if (count($tasks)) {
                ...
                foreach ($tasks as $g) {
            ?>
            <tr id="tr_<?php echo $g->td_id;?>">
              <td><?php echo $i;?></td>
              <td><strong><i><?php echo $g->td_subject;?></i></strong></td>
              <td><?php echo $g->contact_name;?></td>
              <td><?php echo $g->acc_name;?></td>
              <td><?php echo $g->start_date;?></td>
              <td><?php echo $g->start_time;?></td>
              <td><?php echo $g->td_status;?></td>
              <td><?php echo $g->assign_to;?></td>
              <td><?php echo $g->user_fname;?></td>
              <td style="width:70px;">
                <a href='<?php echo $base_link; ?>task_detail/view/<?php echo $g->td_id;?>' class='text-muted'><span class='fa fa-edit'></span></a>&nbsp;&nbsp;
                <button type="button" class="btn del-mod" data-id="<?php echo $g->td_id;?>" data-toggle="modal" data-target="#modal-del"><span class='fa fa-trash-alt'></span></button>
              </td>
            </tr>
            <?php
                  $i++;
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      ...
      <div class="modal-body">
        <p>Are you sure want to delete this Alert/Reminder ?</p>
      </div>
    ...
    $.ajax({
      ...
      success: function (data) {
        if ($.trim(data) == 'Success') {
          ...
          Toast.fire({
            icon: 'success',
            title: ' Alert/Reminder Successfully Removed'
          });
        } else {
          $('#modal-del').modal('toggle');
          Toast.fire({
