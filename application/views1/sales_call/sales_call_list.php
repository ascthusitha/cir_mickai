    ...
    <div class="card">
      <div class="card-header">
        <div class="card-tools">
          <a href="<?php echo $base_link; ?>sales_call/add" type="button" class="btn btn-primary btn-block"><i class="fas fa-plus-circle"></i> Add New</a>
        </div>
      </div>
      <div class="card-body">
        <table class="table table-striped table-bordered" width="100%"  id="account_table">
          ...
          <tbody>
            <?php
              if (count($sales_call)) {
                $i=1;
                foreach ($sales_call as $g) {
                  ?>
            <tr id="tr_<?php echo $g->sc_id;?>">
              <td><?php echo $i;?></td>
              ...
              <td style="width:70px;">
                <a href='<?php echo $base_link; ?>sales_call/view/<?php echo $g->sc_id;?>' class='text-muted'><span class='fa fa-edit'></span></a>&nbsp;&nbsp;
                <button type="button" class="btn del-mod" data-id="<?php echo $g->sc_id;?>" data-toggle="modal" data-target="#modal-del"><span class='fa fa-trash-alt'></span></button>
              </td>
            </tr>
            <?php
                  $i++;
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      ...
      <div class="modal-body">
        <p>Are you sure want to delete this External Appointment ?</p>
      </div>
...
<script type="text/javascript">
  ...
  $( "#del-yes" ).click(function() {
    ...
    $.ajax({
      type: 'POST',
      url: base_url + 'sales_call/delete/',
      data: {sc_id: id},
      success: function (data) {
        if ($.trim(data) == 'Success') {
          ...
          Toast.fire({
            icon: 'success',
            title: ' External Appointment Successfully Removed'
          });
        } else {
          $('#modal-del').modal('toggle');
          Toast.fire({
