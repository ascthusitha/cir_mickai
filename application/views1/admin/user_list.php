    ...
    <div class="card">
      <div class="card-header">
        <div class="card-tools">
          <a href="<?php echo $base_link; ?>user/add" type="button" class="btn btn-primary btn-block"><i class="fas fa-plus-circle"></i> Add New</a>
        </div>
      </div>
      <div class="card-body">
        <table class="table table-striped table-bordered" id="user_table">
          ...
          <tbody>
            ...
            <tr id="tr_<?php echo $user->user_id;?>">
              ...
              <td style="width:70px;">
                <a href='<?php echo $base_link; ?>user/view/<?php echo $user->user_id;?>' class='text-muted'><span class='fa fa-edit'></span></a>&nbsp;&nbsp;
                <button type="button" class="btn del-mod" data-id="<?php echo $user->user_id;?>" data-toggle="modal" data-target="#modal-del"><span class='fa fa-trash-alt'></span></button>
              </td>
            </tr>
            <?php
                  $i++;
