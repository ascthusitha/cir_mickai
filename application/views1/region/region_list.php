    ...
    <div class="card">
      <div class="card-header">
        <div class="card-tools">
          ...
          <a href="<?php echo $base_link; ?>region/add" type="button" class="btn btn-primary btn-block"><i class="fas fa-plus-circle"></i> Add New</a>
          <?php }?>
        </div>
      </div>
      <div class="card-body">
        <table id='region_table' class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            ?>
            <tr id="tr_<?php echo $region->region_id;?>">
              <td><?php echo anchor('region/view/' . $region->region_id, $region->region_name);?></td>
              <td><?php echo $region->created_user;?></td>
              <td><?php echo $region->created_date;?></td>
              <td><button type="button" class="btn del-mod" data-id="<?php echo $region->region_id;?>" data-toggle="modal" data-target="#modal-del"><span class='fa fa-trash-alt'></span></button></td>
            </tr>
            <?php
                }
              }
    ...
    $.ajax({
      ...
      success: function (data) {
        if ($.trim(data) == 'Success') {
          ...
          Toast.fire({
            icon: 'success',
            title: ' Region Successfully Removed'
          });
        } else {
          $('#modal-del').modal('toggle');
          Toast.fire({
